                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :nav="false" :autoplay="true" :dots="false" :looped="true">
                                    <div class="pt" @click="changeimg(images[0])" :class="images[0] == default_img ? 'active' : '' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeimg(images[1])" :class="images[1] == default_img ? 'active' : '' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeimg(images[2])" :class="images[2] == default_img ? 'active' : '' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeimg(images[3])" :class="images[3] == default_img ? 'active' : '' ">
...
<script>
// @ is an alias to /src
import HeaderMocha from '@/components/HeaderMocha.vue'
import FooterMocha from '@/components/FooterMocha.vue'
import carousel from 'vue-owl-carousel'
import RelatedMocha from '@/components/RelatedMocha.vue'
